...
me.getBio = function() {
	return "this is fake!";
}; //set new property on our instance

me.setName("Alexis Turner");
console.log(me.getBio());
//returns this is fake. first looks on 'me', found getBio, never moves up
//does not affect new Person instance, goes up Prototype chain to getBio
